...
if __name__ == "__main__":
    ...
    repos = [
        ("raymondzmc/saebench_pythia-160m-deduped_width-4096", "pythia-160m-deduped"),
        ("raymondzmc/saebench_pythia-160m-deduped_width-16384", "pythia-160m-deduped"),
        ("raymondzmc/saebench_pythia-160m-deduped_width-65536", "pythia-160m-deduped"),
    ]
    exclude_keywords = ["checkpoints", "lagrangian"]
    include_keywords = []
